...
import vip.bot.messages.TCDontSeeEnemy;
import vip.bot.messages.TCSeeEnemy;
...
public class FirepowerConcentrationKnowledge {
    ...
    public FirepowerConcentrationKnowledge(UT2004BotModuleController bot, UT2004TCClient client) {
        _bot = bot;
        _client = client;
    }

    public void update(){
        UT2004TCClient cli = _client;
        ...
        _isee.forEach(playerId -> _client.sendToTeam(new TCSeeEnemy(playerId, _bot.getInfo().getId())));
