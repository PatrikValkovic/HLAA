...
import vip.bot.messages.TCGoingToPick;
import vip.bot.utils.Inventory;
import vip.bot.utils.Navigation;
import vip.bot.utils.WeaponPickingValues;
...
public class PickingBehavior extends BaseBehavior {
    ...
    public PickingBehavior(UT2004BotVIPController bot, KnowledgeBase knowledge) {
        super(bot, knowledge);
    }
    public PickingBehavior(UT2004BotVIPController bot, double priority, KnowledgeBase knowledge) {
