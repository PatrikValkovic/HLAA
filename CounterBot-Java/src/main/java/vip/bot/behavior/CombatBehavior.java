...
public class CombatBehavior extends BaseBehavior {
    ...
    public CombatBehavior(UT2004BotVIPController bot) {
        super(bot);
    }
    public CombatBehavior(UT2004BotVIPController bot, double priority) {
        super(bot, priority);
    }
    public CombatBehavior(UT2004BotVIPController bot, KnowledgeBase knowledge) {
        super(bot, knowledge);
    }
    public CombatBehavior(UT2004BotVIPController bot, double priority, KnowledgeBase knowledge) {
