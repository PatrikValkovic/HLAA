...
import hlaa.tdm.utils.LogitMeasure;
 ...
 */
@AgentScoped
public class CoordinateFirepowerBot extends UT2004BotTCController<UT2004Bot> {

	private static AtomicInteger BOT_COUNT = new AtomicInteger(0);

	private final LogitMeasure _measure = new LogitMeasure();
    ...
    public Initialize getInitializeCommand() {
		...
		String targetName = CoordinateFirepowerBot.class.getSimpleName() + botInstance;
    ...
    /**
     * Method that is executed only once before the first {@link CoordinateFirepowerBot#logic()}
     */
    ...
    public static void main(String args[]) throws PogamutException {
    	...
    	new UT2004BotRunner(CoordinateFirepowerBot.class, CoordinateFirepowerBot.class.getSimpleName())
				.setMain(true)
