 ...
 */
@AgentScoped
public class LookBehingBot extends UT2004BotTCController<UT2004Bot> {
    ...
    public Initialize getInitializeCommand() {
		...
		String targetName = LookBehingBot.class.getSimpleName() + botInstance;
    ...
    /**
     * Method that is executed only once before the first {@link LookBehingBot#logic()}
     */
    ...
    public static void main(String args[]) throws PogamutException {
    	...
    	new UT2004BotRunner(LookBehingBot.class, LookBehingBot.class.getSimpleName())
				.setMain(true)
