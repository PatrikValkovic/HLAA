...
import hlaa.tdm.behavior.GoToBehaviour;
import hlaa.tdm.behavior.LookAroundBehavior;
import hlaa.tdm.behavior.MedkitBehavior;
 ...
 */
@AgentScoped
public class MedkitBot extends UT2004BotTCController<UT2004Bot> {
    ...
    public Initialize getInitializeCommand() {
		...
		String targetName = MedkitBot.class.getSimpleName() + botInstance;
    ...
    /**
     * Method that is executed only once before the first {@link MedkitBot#logic()}
     */
    ...
    public void beforeFirstLogic() {
		...
		_behavior = new BehaviorManager(this)
				.addBehavior(new MedkitBehavior(this, 20, _knowledge))
				.addBehavior(new GoToBehaviour(this, 10, new Location(1750, 50, -130)))
    ...
    public static void main(String args[]) throws PogamutException {
    	...
    	new UT2004BotRunner(MedkitBot.class, MedkitBot.class.getSimpleName())
				.setMain(true)
