...
public class WolfBot extends UT2004BotModuleController {
	...
	Set<String> wolfs = new HashSet<>(4);
    ...
    public void logic() throws PogamutException {
    	...
    	sayGlobal("Wolf: " + info.getId().getStringId());
    	
    	// DO YOUR ACTION-SELECTION HERE
		if(!players.canSeePlayers() ||
				wolfs.contains(players.getNearestVisiblePlayer().getId().getStringId())){
